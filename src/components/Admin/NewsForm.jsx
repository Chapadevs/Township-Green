...
export default function NewsForm({ news, onClose, onSuccess }) {
  const { createNews, updateNews, uploadImage } = useHeroNews();
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div className="space-y-2">
            ...
            <textarea
              ...
              placeholder="Enter a short description for this news item"
            />
            <p className="text-xs text-[var(--text-muted)]">
              Optional - This will be displayed below the title on the homepage
            </p>
          </div>
